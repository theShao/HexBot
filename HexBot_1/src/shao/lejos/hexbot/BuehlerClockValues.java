...
/**
 * 
 * BuehlerClock class - specific rather than general implementation in that it takes a time input as ms and returns angles in degrees and speeds in degrees/s
 * uses ints throughout once init complete for speed.
 * @author Shao
 *
 */

public class BuehlerClockValues {
